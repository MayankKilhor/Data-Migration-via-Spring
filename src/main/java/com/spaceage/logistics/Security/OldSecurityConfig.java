package com.spaceage.logistics.Security;//package com.spaceage.logistics.Security;
//
//import com.spaceage.logistics.Model.Security.ApiAccessControl;
//import com.spaceage.logistics.Model.Security.Authority;
//import com.spaceage.logistics.Repository.ApiAccessControlRepository;
...
//
//    @Autowired
//    public OldSecurityConfig(CorsFilter corsFilter, ApiAccessControlRepository apiAccessControlRepository) {
...
//
//    @Autowired
//    public SecurityConfig(ApiAccessControlRepository apiAccessControlRepository) {
//        this.apiAccessControlRepository = apiAccessControlRepository;
//    }
//
//    @Bean
...
//        config.setAllowedOrigins(List.of("https://development-server.d1pjtdnf52rphk.amplifyapp.com"));
